<template>
  <div id="app">
      ...
      <tar-bar id="tar-bar">
        ...
        <tar-bar-item class='tar-bar-item' slot="tar-bar-item" path='/list' activeColor='green'>
        ...
        <tar-bar-item class='tar-bar-item' slot="tar-bar-item" path='/send' activeColor='yellow'>
